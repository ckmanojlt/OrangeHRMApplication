...
import com.OHRM_TestNGAssignments.OHRM_BaseTest;

public class OHRM_UsingLog extends OHRM_BaseTest{
...
log.info(Actual_OHRM_HomePage_AdminText);
//log.error(Actual_OHRM_HomePage_AdminText);
//log.warn(Actual_OHRM_HomePage_AdminText);
